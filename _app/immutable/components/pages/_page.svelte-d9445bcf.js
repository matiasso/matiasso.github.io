import { E as assign, a2 as now, a3 as loop, a4 as identity, S as SvelteComponent, i as init, s as safe_not_equal, Y as add_render_callback, k as element, a as space, x as create_component, l as claim_element, m as children, h as detach, c as claim_space, y as claim_component, n as attr, b as insert_hydration, z as mount_component, I as listen, f as transition_in, t as transition_out, a5 as destroy_each, A as destroy_component, a1 as component_subscribe, o as onMount, a6 as globals, e as empty, q as text, r as claim_text, a7 as src_url_equal, p as set_style, H as append_hydration, X as run_all, a8 as set_store_value } from "../../chunks/index-91def11a.js";
import { w as writable } from "../../chunks/index-17913fa1.js";
import { c as cubicOut } from "../../chunks/index-9243a1e2.js";
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      t5 = claim_text(p0_nodes, "I'm a 3rd year computer science student at Aalto University, with minors in Data Science and\n			Mathematics. I'm a highly motivated individual who is passionate about exploring the limitless\n			possibilities that technology has to offer. During my studies, I have developed a good\n			understanding of programming languages such as Python, Scala and TypeScript, which has enabled\n			me to take on projects ranging from simple web applications to more-complex algorithms.\n			");
      ...
      t10 = claim_text(p1_nodes, "You can find me on:");
    ...
    h() {
      attr(h1, "class", "text-gray-700 dark:text-gray-200 svelte-6gga4x");
      attr(h2, "class", "text-gray-600 dark:text-gray-300 svelte-6gga4x");
      attr(div0, "class", "nameContainer svelte-6gga4x");
      attr(img0, "id", "avatar");
      attr(img0, "width", "512");
      ...
      attr(img0, "class", "svelte-6gga4x");
      attr(div1, "class", "imageContainer svelte-6gga4x");
      attr(p0, "id", "contentText");
      attr(p0, "class", "text-black dark:text-white svelte-6gga4x");
      attr(p1, "class", "text-black dark:text-white");
      attr(img1, "class", "socialIcon svelte-6gga4x");
      ...
      attr(img2, "class", "socialIcon svelte-6gga4x");
      ...
      attr(div2, "class", "footerContainer svelte-6gga4x");
      attr(div3, "class", "infoContainer svelte-6gga4x");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "bg-lightbg dark:bg-darkbg");
      attr(div, "style", div_style_value = `position: absolute; z-index: -1; top: ${/*scrollY*/
    ...
    p(ctx2, [dirty]) {
      ...
      2 && div_style_value !== (div_style_value = `position: absolute; z-index: -1; top: ${/*scrollY*/
      ctx2[1]}px; left: 0px; width: 100%; height: 100vh; overflow: hidden; pointer-events: none`)) {
        attr(div, "style", div_style_value);
      }
      const dialog_changes = {};
      if (dirty & /*$$scope, $imgRadius*/
      4100) {
