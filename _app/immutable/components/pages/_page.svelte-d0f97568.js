...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(h1, "class", "text-gray-700 dark:text-white svelte-1n5b787");
      ...
      attr(img0, "class", "svelte-1n5b787");
      attr(div2, "class", "imageContainer svelte-1n5b787");
      attr(p0, "id", "contentText");
      attr(p0, "class", "text-black dark:text-white svelte-1n5b787");
      attr(p1, "class", "text-black dark:text-white");
      attr(img1, "class", "socialIcon svelte-1n5b787");
      ...
      attr(div5, "class", "fullscreenContainer svelte-1n5b787");
    },
    m(target, anchor) {
